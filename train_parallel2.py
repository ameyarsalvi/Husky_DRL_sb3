...
tmp_path = "/home/asalvi/code_workspace/tmp/sb3_log/log2/"
# set up logger
...
if __name__ == '__main__':
    ...
    checkpoint_callback = CheckpointCallback(save_freq=50000,save_path="/home/asalvi/code_workspace/tmp/sb3_log/checkpoints2/",name_prefix="rl_model2",save_replay_buffer=True,save_vecnormalize=True)
  # Using the followin best hyperparams
    ...
    model = PPO("CnnPolicy", env,learning_rate=0.0001, n_steps=512, batch_size=64, n_epochs=4, ent_coef= 0.2, gamma=0.999, gae_lambda=0.98,
