...
tmp_path = "/home/asalvi/code_workspace/tmp/sb3_log/conePath/"
# set up logger
...
if __name__ == '__main__':
    ...
    model = PPO("MlpPolicy", env,learning_rate=0.00001, n_steps=256, batch_size=256, n_epochs=5, ent_coef= 0.005, gamma=0.98, gae_lambda=0.98,
