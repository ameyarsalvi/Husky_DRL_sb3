...
#konsole --noclose --new-tab -e ./coppeliaSim.sh -GzmqRemoteApi.rpcPort=23022 -GwsRemoteApi.port=23071 ~/code_workspace/Husky_CS_SB3/HuskyModels/HuskyInfinityGym.ttt && /bin/bash &
