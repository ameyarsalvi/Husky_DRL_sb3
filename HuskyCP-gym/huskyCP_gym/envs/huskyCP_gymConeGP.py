...
class HuskyCPEnvConeGP(Env):
    def __init__(self,port,seed,track_vel):
        ...
        path = '/home/asalvi/code_workspace/Husky_CS_SB3/GPModels/'
    ...
    def invKin(self):
        ...
        mu1, sigma1 = self.Beta1_grass.predict(input, return_std = True)
        mu2, sigma2 = self.Beta2_grass.predict(input, return_std = True)
    ...
    def get_map(self):
        ...
        mu1, self.sigma1 = self.Beta1_grass.predict(input, return_std = True)
        self.sigma1 = self.sigma1.item()
        mu2, self.sigma2 = self.Beta2_grass.predict(input, return_std = True)
        self.sigma2 = self.sigma2.item()
